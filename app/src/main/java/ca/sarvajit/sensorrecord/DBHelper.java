...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String SUBJECTS_RESEARCH_ASSISTANT = "CONTEXT";
    public static final String SUBJECTS_ID = "id";
    public static final String SUBJECTS_CONDITION = "frequency";
    ...
    public void insertSubjectTemp(Short subNum, String date, String RA,
        ...
        subjectData.put(SUBJECTS_CONDITION, frequency);
    ...
    public void insertDataTemp(short subNum, long time,
                               ...
                               float[] proxi,
                               float[] light,
                               float[] step, float[] gpsmatrix) throws SQLException {
        ...
        sensorValues.put(PROXIMITY,proxi[0]);
        sensorValues.put(LIGHT,light[0]);
        sensorValues.put(STEP_DETECTOR,step[0]);
        sensorValues.put(LONGITUDE,gpsmatrix[0]);
        sensorValues.put(LATITUDE,gpsmatrix[1]);
    ...
    public void exportSubjectData(File outputFile, String subNum) throws IOException, SQLException {
        ...
        while (curCSV.moveToNext()) {
            ...
            String arrStr[] = {curCSV.getString(0), curCSV.getString(1), curCSV.getString(2),
                    ...
                    curCSV.getString(21), curCSV.getString(22),curCSV.getString(23),curCSV.getString(24),
                    curCSV.getString(25),curCSV.getString(26),curCSV.getString(27)};
        ...
        /*StorageReference riversRef = storagereference.child(outputFile.getName());
        filepath=outp;
